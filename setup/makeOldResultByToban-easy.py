...
print(trainStartDate,trainEndDate)
    ...
    with dbh.cursor() as membercursor:
        ...
        # 終わったらraceId別にテーブルに突っ込む
                with dbh.cursor() as insOldRaceByTobanCursor:
                    ins_sql = "INSERT INTO oldResultByTobanEasy                                (raceId,toban,lane,oldRank1,oldRank2,oldRank3,oldRank4,oldRank5,oldRank6,                                 avgStartDev,avgStartTime)                                VALUES                                ('%s','%s',%d,%f,%f,%f,%f,%f,%f,%f,%f) "                              % (raceId,tobanHash['rmToban'],lane,
